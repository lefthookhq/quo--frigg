#!/usr/bin/env node
/**
 * Script to create Quo PRODUCTION webhook subscriptions for call and message events
 *
 * Usage: node scripts/create-quo-webhooks-prod.js
 */

const { Api } = require('../backend/src/api-modules/quo/api');

// Production Configuration
const API_KEY = 'XzWOC2FJGTGLR8mOnlZnGFoFEThynzFs';
const WEBHOOK_URL = 'https://webhook.site/5b15ea91-bc99-47da-b0c4-2df2c17ad7be';
const BASE_URL = 'https://api.openphone.com'; // Production uses openphone.com, not quo
...
async function createWebhooks() {
    ...
    console.log('Creating Quo PRODUCTION webhook subscriptions...\n');
