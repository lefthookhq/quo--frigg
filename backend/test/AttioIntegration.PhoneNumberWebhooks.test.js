...
describe('BaseCRMIntegration - Phone Number ID Webhook Subscriptions', () => {
    ...
    describe('_handlePhoneIdUpdate', () => {
        it('should detect changes in enabledPhoneIds array', async () => {
            // Arrange
            integration.config = {
                enabledPhoneIds: ['phone-id-1', 'phone-id-2'],
            ...
            const newConfig = {
                enabledPhoneIds: ['phone-id-1', 'phone-id-3'],
            };

            mockQuoApi.updateWebhook.mockResolvedValue({
                data: { id: 'webhook-msg-123' },
            });
        ...
        it('should update message webhook with new resourceIds', async () => {
            // Arrange
            integration.config = {
                enabledPhoneIds: ['phone-id-1'],
                quoMessageWebhookId: 'webhook-msg-123',
                quoCallWebhookId: 'webhook-call-123',
                quoCallSummaryWebhookId: 'webhook-summary-123',
            };
            ...
            const newConfig = {
                enabledPhoneIds: ['phone-id-1', 'phone-id-2', 'phone-id-3'],
            };
        ...
        it('should update call webhook with new resourceIds', async () => {
            // Arrange
            integration.config = {
                enabledPhoneIds: ['phone-id-1'],
                quoMessageWebhookId: 'webhook-msg-123',
            ...
            const newConfig = {
                enabledPhoneIds: ['phone-id-2'],
            };

            mockQuoApi.updateWebhook.mockResolvedValue({
                data: { id: 'webhook-call-123' },
            });
        ...
        it('should update call summary webhook with new resourceIds', async () => {
            // Arrange
            integration.config = {
                enabledPhoneIds: ['phone-id-1'],
                quoMessageWebhookId: 'webhook-msg-123',
        ...
        it('should not update webhooks if no changes detected', async () => {
            // Arrange
            integration.config = {
                enabledPhoneIds: ['phone-id-1', 'phone-id-2'],
                quoMessageWebhookId: 'webhook-msg-123',
        ...
        it('should throw error if webhooks not configured', async () => {
            // Arrange
            integration.config = {
                enabledPhoneIds: ['phone-id-1'],
                // No webhook IDs
