...
class ScalingTestIntegration extends BaseCRMIntegration {
    static Definition = {
        ...
        display: {
            ...
            description: 'Integration for testing scalability using Quo API and synthetic data',
            category: 'Testing',
            detailsUrl: '',
            icon: '',
        },
    ...
    async logSMSToActivity(activity) {
        console.log('ScalingTest: SMS logged (simulated)', activity.contactExternalId);
    }
    ...
    async logCallToActivity(activity) {
        console.log('ScalingTest: Call logged (simulated)', activity.contactExternalId);
    }
