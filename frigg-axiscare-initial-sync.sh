...
# Frigg AxisCare Initial Sync Script
# Triggers an initial sync for the AxisCare integration
# 
# Usage: ./frigg-axiscare-initial-sync.sh [INTEGRATION_ID]
#
...
#   FRIGG_API_KEY="your-key" FRIGG_APP_USER_ID="your-user" ./frigg-axiscare-initial-sync.sh 2

FRIGG_URL="http://localhost:3001"
INTEGRATION_ID="${1:-2}"

echo "=== Frigg AxisCare Initial Sync ==="
